...
import Bluprint from "../../assets/Footer/Bluprint.jpg";


const Footer = () => {
  return (
    <div className=" h-[14.3vw] flex justify-center bg-primary-800">
      <div className=" w-[85vw] z-10 mt-[1.3vw] py-[1.7vw] flex flex-row">
        ...
        <div className=" w-[30vw] flex flex-col items-center gap-[1vw]">
            ...
            <ul className="flex flex-row text-primary-300 text-[2vw] gap-[3vw]">
                <li><a className="hover:text-primary-100 transition-colors duration-200" href=""><FaInstagram/></a></li>
                <li><a className="hover:text-primary-100 transition-colors duration-200" href=""><FaLinkedinIn/></a></li>
                <li><a className="hover:text-primary-100 transition-colors duration-200" href=""><FaGithub /></a></li>
                <li><a className="hover:text-primary-100 transition-colors duration-200" href=""><FaTelegramPlane /></a></li>
                <li><a className="hover:text-primary-100 transition-colors duration-200" href=""><FaWhatsapp /></a></li>
            </ul>
        ...
        <ul className="w-full h-full flex items-center justify-center text-primary-300 text-[1.5vw] gap-[3vw] font-semibold">
            <li className="flex flex-col gap-[1vw] items-center"><a className="hover:text-primary-100 transition-colors duration-200" href="#about">About</a><a className="hover:text-primary-100 transition-colors duration-200" href="">Skills</a></li>
            <li className="flex flex-col gap-[1vw] items-center"><a className="hover:text-primary-100 transition-colors duration-200" href="">Projects</a><a className="hover:text-primary-100 transition-colors duration-200" href="">Blogs</a></li>
        </ul>
        </div>
      </div>
    </div>
