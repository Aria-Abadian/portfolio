...
const BlogsFooter = () => {
  ...
  return (
    <div
      className="md:h-[14.3vw] bottom-0 flex justify-center bg-primary-800 overflow-hidden"
      id="contact"
    >
        ...
        <div className="w-full md:w-[28.3vw] h-full flex flex-col items-center md:order-3">
          ...
          <ul className="w-full h-full flex items-center justify-center text-primary-300 md:text-[1.5vw] gap-[3vw] font-semibold">
            <li className="flex flex-col gap-[1vw] items-center">
              <NavLink className={linksClasses} to='/#about'>
                About
              </NavLink>
              <NavLink className={linksClasses} to='/#skills'>
                Skills
              </NavLink>
            </li>
            <li className="flex flex-col gap-[1vw] items-center">
              <NavLink className={linksClasses} to='/#demo'>
                Projects
              </NavLink>
              <NavLink className={linksClasses} to='/#blogs'>
                Blogs
              </NavLink>
            </li>
          </ul>
